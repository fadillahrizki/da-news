...
function Detail() {
  ...
  <div className="p-3">
    ...
    {post && (
      <div>
        <img loading='lazy' src={post.image ? post.image : ('https://placehold.co/600x400?text='+post.title)} alt={post.title} className="w-full h-64 object-cover rounded-lg object-top" />
